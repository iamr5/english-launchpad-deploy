...
# --------------------------------------------------------------- frases modelo
model_sentences = {
'A1':['Hello, my name is Ana. Nice to meet you.','I go to {place} every week.','I have {object} every day.','Can you help me, please?','I like {topic} very much.'],
...
model_sentences_es = {
'A1':['Hola, me llamo Ana. Mucho gusto.','Voy a {place} cada semana.','Tomo/como {object} todos los días.','¿Me puedes ayudar, por favor?','Me gusta mucho {topic}.'],
