...
}, 488399:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 488503:() => {
  try {
...
}, 491551:a => window.h.qa(a).L.sampleRate, 491624:a => {
  a = window.h.qa(a);
