...
(function () {
  ...
  const modulo3_1 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-1-intro', type: 'intro', markdown: `¡Hola, soy **Bussy** 🚌! En esta misión **viajaremos al pasado** ⏳ y hablaremos de cosas que **ya pasaron**.
...
> 💡 **Truco de Bussy:** si dices **cuándo** exacto pasó → **Pasado Simple**. Si hablas de **experiencia o resultado** sin fecha → **Presente Perfecto** con **have/has + participio**.
...
🚍 **Misión cumplida:** ya puedes contarle a Bussy lo que **hiciste ayer** y lo que **has hecho** en la vida. ¡Sigue así y descubrirás más aventuras gramaticales!
...
**🏅 Insignia obtenida:** 🎖 *Tiempo Viajero* (Experto en Presente Perfecto vs. Pasado Simple) ⏳🌍` },
  ...
  const modulo3_2 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-2-intro', type: 'intro', markdown: `¡Hola de nuevo! Soy **Bussy** 🚍😊. ¿Recuerdas cuándo eras niño o niña? Hoy exploraremos cómo hablar de **hábitos pasados** y de **costumbres**.
...
Se vuelve *"didn't use to"* o *"Did you use to...?"*. ❌ *"She didn't used to like chocolate."* ✅ *"She didn't use to like chocolate."*`,
      ...
      { id: 'modulo3-2-resumen', type: 'resumen', markdown: `#### **🧳 Las tres maletas de Bussy**
...
**🏅 Insignia obtenida:** *Hábito Pasado* 🎖` },
  ...
  const modulo3_3 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-3-intro', type: 'intro', markdown: `¡Atención, aspirante a inglés! 🚌 Soy **Bussy** y hoy lanzamos los **dados de la suerte** 🎲.
...
**🏅 Insignia obtenida:** ✨ *Maestro de Condicionales* desbloqueada. ¡A seguir explorando! 🎲` },
  ...
  const modulo3_4 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-4-intro', type: 'intro', markdown: `¡Hey, buen trabajo hasta ahora! Soy **Bussy** 🚌. En nuestra siguiente misión aprenderás a **contar lo que otros dijeron**, pero usando tus propias palabras.
...
🎙️ **Metáfora de Bussy:** Imagina que **grabas la voz** de alguien (estilo directo) y luego la **reproduces con tu voz** (estilo indirecto). Debes **adelantar el tiempo** un poco: presente → pasado, *future* → *would*. Atención a los **discursivos mágicos**: **if** para preguntas sí/no y verbos como **told/asked + to** para órdenes. ✨`,
        miniQuiz: [
...
Con estas palabras vas a poder describir tu profesión, tus estudios y todo lo que pasa en tu día a día digital y social. ¡Vamos a empacar, ruter@!` },
      { id: 'modulo3-5-intro', type: 'intro', markdown: `¡Hey, ruter@! Soy **Bussy** 🚌, y hoy seguimos avanzando en esta gran aventura.
...
**🏅 Insignia obtenida:** *Vocabulario Funcional* 🧳✨` },
  ...
  const modulo3_6 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-6-intro', type: 'intro', markdown: `¡Nos vamos acercando a la cima, ruter@! 🏔️ Soy **Bussy** 🚌, y hoy toca poner por escrito todo lo aprendido.
...
Al terminar, tus oraciones dejarán de sonar sueltas y separadas, y empezarán a fluir como un viaje sin baches. 🛣️✨` },
      { id: 'modulo3-7-intro', type: 'intro', markdown: `¡Hola, ruter@! Soy **Bussy** 🚌, y… ¡estamos a punto de terminar! 🎉
...
🚌 **Tip de Bussy:** *yet* también contrasta, como en *"He loves music, **yet** he never goes to concerts."* (Le encanta la música, **aunque** nunca va a conciertos.)`,
        miniQuiz: [
...
**🏅 Insignia obtenida:** *Constructor de Ideas* 👷‍♂️🧱✨` },
  ...
  const modulo3_8 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo3-8-intro', type: 'intro', markdown: `¡Lo hicimos hasta el final del viaje! 🥹🚌 Soy **Bussy**, y hoy somos exploradores listos para el **PET**. Para una buena ruta no basta con saber inglés: necesitas **herramientas estratégicas**. 🧰
...
¡Vamos a cazar esos errores en frases reales! 🕵️‍♂️`,
        miniQuiz: [
          ...
          tap('Corrige el cierre de la carta formal:', ['Yours', 'faithful,', 'Bussy'], 1, 'faithfully,'),
...
**🏅 Insignia obtenida:** ✨ *Maestro del PET* 🎖️` },
    ...
    quizQuestions: [
      ...
      rebuild('🎧 Reconstruye el cierre formal:', 'Yours faithfully, Bussy', ['Yours', 'faithfully,', 'Bussy', 'See', 'soon', 'Hi']),
