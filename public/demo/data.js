...
const microlection1 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo1-1-intro', type: 'intro', markdown: `¡Hola! Soy **Bussy**, tu bus guía 😊. Hoy vamos a aprender a contar lo que haces normalmente o lo que está pasando, como si le contaras a alguien tu rutina mientras vamos en el bus 🚍 o esperas la combi ⌚.
...
const microlection3 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo3-intro', type: 'intro', markdown: `¡Hey, ruter@! Soy **Bussy** 🚌, y hoy te presento el *superpoder* favorito de Is-abella:
...
**Bussy tip:** la próxima vez que vayas por la calle, intenta pensar en inglés lo que ves. Por ejemplo: *"This is a tree. It is tall. That is a bus. It is old. The bus is yellow."* – Estarás practicando demostrativos y artículos en tu mente. ¡Paja, no! 😎
...
const microlection5 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo5-intro', type: 'intro', markdown: `¡Hola! Soy Bussy 🚌🗺️, tu guía viajero. Imagina que vas en el bus, miras por la ventana y te preguntas *"¿Dónde estoy?"*. Hoy aprenderemos a responder eso describiendo lo que **hay** a tu alrededor y **dónde** está cada cosa.
...
const microlection6 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo6-intro', type: 'intro', markdown: `¡Hola de nuevo! Bussy el bus está de regreso, más curioso que nunca 🕵️‍♂️. Ya sabes hacer afirmaciones sobre personas y cosas, y ubicarlas; ¡ahora toca **preguntar**! Las **palabras Wh-atsapp** son las preguntas abiertas que te permiten pedir TODO tipo de información.
...
const microlection7 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo7-intro', type: 'intro', markdown: `¡Hello! 👋 Soy Bussy, tu guía, y hoy armaremos un kit de supervivencia lingüística. Cuando viajas en bus o caminas por la ciudad, hay frases básicas que necesitas para ser amable y hacerte entender con la gente. Cosas como saludar al subir, dar las gracias, pedir permiso para bajar, o disculparte si empujas sin querer.
...
const microlection8 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo8-intro', type: 'intro', markdown: `¡Hola, hola! 🎤 Soy Bussy, tu coach de pronunciación por hoy. Sabemos que el inglés escrito a veces no suena como se ve. Y para nosotros hispanohablantes, hay ciertos sonidos que son como los "jefes finales" del videojuego de la pronunciación: un poco tricky (complicados) 😅.
...
const microlection9 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo9-mision', type: 'mision', markdown: `¡Llegaste al gran momento! 📋✨ En este simulacro de fin de módulo pondrás a prueba todo lo aprendido. Bussy, Is-abella y Do-ménica están aquí contigo, ¡animándote desde la primera fila! 🚌🎉` },
...
Ahora, Bussy, Is-abella, Do-ménica y todo el equipo de TuRuta English te otorgamos la ¡Insignia Final de Módulo 1! 🏅

Has ganado el ✨ **Certificado Interno TuRuta – Nivel A1**.

¿Qué sigue? El nivel A2 aguarda con nuevos desafíos (¡como hablar en pasado y futuro!). Pero por hoy, celebra tu logro. Tómate una selfie mental con Bussy y nuestras agentes secretas y di "I did it!" 🥳📸.
...
("Brichero/a" en jerga peruana se refiere a la persona que coquetea con turistas o extranjeros. Aquí lo usamos en plan divertido, ¡sin estereotipos ofensivos, solo buena onda y práctica real!)` },
    { id: 'modulo10-intro', type: 'intro', markdown: `Hi there! Soy Bussy 🚌💘, tu wingman sobre ruedas. En esta microlección extra nos ponemos en modo conquistador@. Vamos a aprender frases y expresiones útiles para coquetear en inglés con humor y claridad, sin pasarnos de confianzudos.
...
const modulo2_1 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-1-intro', type: 'intro', markdown: `¡Hola otra vez! Soy **Bussy** 🚌, tu bus guía. En la micro anterior aprendiste a hablar de **rutinas** con el **Presente Simple** (lo que haces *siempre*).
...
* ❌ *He is knowing the answer.* → ✅ *He **knows** the answer.* (*know* es verbo de estado → simple).
  ...
  > 💡 **Truco de Bussy:** si la acción **está pasando ahorita** y **se puede ver**, asegúrate de tener **am/are/is + verbo-ing** completos. Si es un **estado interno** (saber, querer, necesitar), vuelve al **simple**.
...
🚍 **Misión cumplida:** ya puedes contarle a Bussy qué estás haciendo en tiempo real: *"I am sitting on the bus and looking out the window."*
...
const modulo2_4 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-4-intro', type: 'intro', markdown: `¡Hola otra vez! Soy **Bussy** 🚌💬. Hoy suben al bus dos pasajeros bien competitivos: uno grita *"I am taller!"* 🙋 y el otro *"No, I'm faster!"* 🏃. ¡Y me toca arbitrar la pelea de "**más que**" y "**el más**"! ⚖️
...
**Adjetivos cortos** → agrega **\`-est\`** y pon **\`the\`** delante:
  ...
  | -------- | ------------- | ---------------------------------------- |
  | fast     | the fastest   | Bussy is **the fastest** bus in the city. 🚌 |
...
- It was the coldest day **of** the year. ❄️`,
      miniQuiz: [
        mc('Bussy is ___ bus in the city. (fast)', ['the fastest', 'the most fast', 'fastest', 'the faster'], 0),
...
const modulo2_5 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-5-intro', type: 'intro', markdown: `¡Hola! Soy **Bussy** 🚍😊. Hoy subes un mago al bus 🎩… ¡y ese mago eres **tú** con **can**!
...
🤓 **Secreto Bussy:** en situaciones formales, **could** es tu as bajo la manga para pedir permiso con **más cortesía**. ¡Guárdalo para impresionar! ✨` },
...
🚍 **Misión cumplida:** responde *"What can you do that's unique?"* con *"I can…"*; y cuando me digas *"Bussy, can I get off here?"* yo te diré *"Yes, you can!"* 😄
...
const modulo2_6 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-6-intro', type: 'intro', markdown: `¡Hola otra vez! Soy **Bussy** 🚌💬 y hoy entran dos invitados muy peleados: la **Agente Should** 😇 y el **Agente Must** 😈, como el angelito y el diablito de tu hombro.
...
const modulo2_7 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-7-intro', type: 'intro', markdown: `¡Hora de hablar de gustos! 😁 Soy **Bussy** 🚌 y hoy te voy a chismear sobre lo que *te encanta* y lo que *no soportas*.
...
const modulo2_8 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-8-intro', type: 'intro', markdown: `¡Hola, agente! Soy **Bussy** 🚌💬 y hoy eres **detective lingüístico** 🕵.
...
const modulo2_9 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-9-intro', type: 'intro', markdown: `¡Hola de nuevo! Soy **Bussy** 🚌💬 y hoy nos vamos de *shopping* 🛍.

Imagina **Gamarra** pero todos hablan inglés 😱. ¿Cómo dices *"¿Cuánto cuesta?"*, *"¿Tiene talla M?"*, *"Solo estoy mirando"*?

> 💡 Tranqui, no necesitas ser un experto. Con un puñado de frases sales del paso como todo un **caserit@ internacional**. Bussy te acompaña a cada vitrina. 👀` },
...
const modulo2_10 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-10-intro', type: 'intro', markdown: `¡Hey, ruter@! Soy **Bussy** 🚌💬 y hoy te veo con **mala cara** 🤒. ¿Te sientes mal? ¡Tranqui! Hoy jugamos a **doctor y paciente**.
...
> 🩺 Hoy me convierto en **Dr. Bussy** y paso consulta. ¡Abre la boca y di *"ahh"*! 😷` },
...
Estos resbalones son **clásicos** al traducir del español. ¡Dr. Bussy te los cura! 💊
...
> 🚍 **Misión cumplida:** Bussy te mira y dice *"You look much better now!"* y tú respondes con seguridad: *"Yes, I am. Thank you for asking!"* 😊
...
const modulo2_11 = {
  ...
  contentBlocks: [
    ...
    { id: 'modulo2-11-intro', type: 'intro', markdown: `¡Hola, viajero! Soy **Bussy**, tu guía de viaje internacional 🌍😎. Hoy nos vamos de aventura y te preparo para todo lo que viene en el camino.
...
¡Saca tu pluma digital que Bussy te enseña a sonar bien en cualquier mensaje! 🖋` },
...
🚍 **Misión cumplida:** Bussy te entrega tu diploma 🎓: *"Ahora hablas, escuchas, lees y escribes en inglés A2 con confianza."*
