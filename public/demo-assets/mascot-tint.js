...
(function (global) {
  ...
  function build(doc, i) {
    ...
    // nada que teñir.
    //
    // Aquí NO va nada más. Dilatar la máscara un píxel y desenfocarla quitaba el
    // hilo de color viejo que queda en el borde suavizado entre dos colores,
    // pero a cambio el teñido se derramaba sobre el contorno y el dibujo salía
    // emborronado. El hilo se ve de cerca; el derrame, siempre.
    ...
    [tone, vivid, proj, ramp, mask, hot, cold, merge]
