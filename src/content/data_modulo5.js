...
¡Hola! {{mascot}} aquí, listo para leer entre líneas 📚💬.
...
> 💡 **Skimming** = idea global. **Scanning** = dato específico. ¡No los confundas!`,
        miniQuiz: [
          ...
          mc('Al terminar un párrafo, ¿qué te recomienda {{mascot}}?', ['Memorizar cada palabra del párrafo', 'Parafrasear la idea en tu mente', 'Saltar directo a la conclusión', 'Traducir el párrafo al español'], 1),
...
> 🤖 {{mascot}} dice: ¡lee con estrategia, no con lupa! Encuentra las pistas y conéctalas. 🔍`,
        miniQuiz: [
          ...
          tap('{{mascot}} busca el dato clave. Corrige el error.', ['The', '2018', 'study', 'was', 'publish', 'in', 'Nature.'], 4, 'published'),
...
¡**{{mascot}}** al habla otra vez! En este nivel, los audios son **más complejos**: seminarios, profesores nativos con **acentos distintos**, debates.
...
**🏅 Insignia obtenida:** *Oído Avanzado* (¡Nada se te escapa!) 🎧🌟` },
  ...
  const modulo5_4 = {
    ...
    contentBlocks: [
      ...
      { id: 'modulo5-4-intro', type: 'intro', markdown: `Soy **{{mascot}}**, y estoy listo para tu presentación final. 📢 Cuando llegues al **nivel C1**, te pedirán **exponer ideas complejas** y **debatir con especialistas**. Necesitas dominar un **speaking académico** claro y persuasivo. 🎓
...
Al terminar sabrás **coordinar** lo que lees y escuchas para responder con orden y precisión. 🚀` },
      { id: 'modulo5-5-intro', type: 'intro', markdown: `¡Hola, soy **{{mascot}}**! ¡Seguimos avanzando! 🎓
...
**🏅 Insignia obtenida:** *Estratega iBT* (¡Multi-habilidades en acción!) 📚🎧📝` },
  ...
  const modulo5_6 = {
    ...
    audioCues: ['Escucha el contenido de la lección.', 'Fíjate en los puntos clave.', 'Ahora vienen tus ejercicios.'],
    contentBlocks: [
      { id: 'modulo5-6-titulo', type: 'titulo', title: '¿Carta, ensayo y entrevista? ¡{{mascot}} te prepara! 🎓', subtitle: 'Estrategias IELTS General: Writing y Speaking', markdown: '' },
      ...
      { id: 'modulo5-6-intro', type: 'intro', markdown: `¡Hola, soy **{{mascot}}** {{mascotEmoji}}! Hoy te cuento un secreto: el **IELTS General** se enfoca en la **vida real**. 😊
...
> 💡 **Truco de {{mascot}}:** en la carta, cubre **todos** los puntos; en el monólogo, **estructura** con conectores. ¡Orden = puntos! 📈
...
En los ejercicios de abajo, **toca la palabra incorrecta** y arréglala 👇.`,
        miniQuiz: [
          ...
          tap('Toca la palabra incorrecta (cierre formal):', ['Yours', 'sincerely', '{{mascot}}', 'Saludos'], 1, 'sincerely,'),
...
¡**Éxitos** en tu camino hacia la **certificación internacional**! 🌍 {{mascot}} confía en ti.
...
**🏅 Insignia obtenida:** 🎖 *Políglota Global* (¡Listo para el mundo!) 🌐🏅` },
    ...
    quizQuestions: [
      ...
      rebuild('Reconstruye el cierre formal:', 'Yours sincerely, {{mascot}}', ['Yours', 'sincerely,', '{{mascot}}', 'Hi', 'regards', 'soon']),
...
Pondrás a prueba las **cuatro habilidades**: *reading*, *writing*, *listening* y *speaking*. ¡Es tu gran simulacro final! 💪✨` },
      { id: 'modulo5-7-intro', type: 'intro', markdown: `¡Has llegado lejos, {{audience}}! 🎓 Soy **{{mascot}}** {{mascotEmoji}}, y hoy te acompaño en tu **simulacro comprensivo de C1**.
...
¡Felicitaciones, {{audience}}! 🎉 **Has completado todo el nivel C1.** 🎓
